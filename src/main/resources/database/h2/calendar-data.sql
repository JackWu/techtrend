...
insert into vehicle (id, color, wheel, seat) values(1, 'orange', 1, 2);
insert into vehicle (id, color, wheel, seat) values(2, 'green', 1, 2);
insert into vehicle (id, color, wheel, seat) values(3, 'blue', 1, 2);