...
import com.techtrend.domain.Event;
...
public class EventDaoJdbcImpl implements EventDao {
    ...
    @Autowired
    public EventDaoJdbcImpl(JdbcOperations jdbcOperations) {
    ...
    private static final RowMapper<CalendarUser> ATTENDEE_ROW_MAPPER = new CalendarUserDaoJdbcImpl.CalendarUserRowMapper("attendee_");
    private static final RowMapper<CalendarUser> OWNER_ROW_MAPPER = new CalendarUserDaoJdbcImpl.CalendarUserRowMapper("owner_");
